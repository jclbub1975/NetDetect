...
function Navbar({ onSignInClick }) { // Accept the onSignInClick prop
    return (
        <nav className="navbar fixed top-0 left-0 w-full bg-white shadow-md text-[#285FF8] flex justify-between items-center z-10 px-10 py-4 transition-all duration-300">
            ...
            <div className="flex gap-4">
                {/* Trigger the passed function to open the modal */}
                <button
                    onClick={onSignInClick} // Call the passed onSignInClick function here
